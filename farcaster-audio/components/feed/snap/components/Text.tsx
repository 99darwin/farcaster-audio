...
export function SnapText({ props }: { props: TextProps }) {
  const fontSize = props.size === 'sm' ? typography.size.sm : typography.size.body;
  const fontWeight = props.weight === 'bold' ? typography.weight.bold : typography.weight.regular;
